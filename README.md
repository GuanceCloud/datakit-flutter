...
If your app runs on Flutter Web, use the Truewatch Browser RUM SDK instead. In a Flutter Web project, load the Browser RUM SDK or your bundled initialization script from `web/index.html` before Flutter starts. This is a Browser RUM SDK integration, not a Flutter plugin integration.

For details, see the [Flutter Web notes](https://docs.truewatch.com/real-user-monitoring/flutter/app-access/#flutter-web) and the [Web RUM integration guide](https://docs.guance.com/real-user-monitoring/web/app-access/).
