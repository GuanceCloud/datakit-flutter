...
class FTConfigCheck {
    ...
    fun validateSDKConfig(args: Map<String, Any?>?, sdkConfig: FTSDKConfig): Boolean {
        val configMap = mapOf(
            ...
            FTMobileAgentFlutter.KEY_ENABLE_LIMIT_WITH_CACHE_SIZE to sdkConfig.isLimitWithCacheSize,
            FTMobileAgentFlutter.KEY_CACHE_LIMIT to sdkConfig.cacheLimit,
            FTMobileAgentFlutter.KEY_CACHE_DISCARD to sdkConfig.cacheDiscard.ordinal,
            FTMobileAgentFlutter.KEY_ENABLE_FILE_DATA_STORE to sdkConfig.isUseFileDataStore,
            FTMobileAgentFlutter.KEY_NEED_TRANSFORM_OLD_CACHE to sdkConfig.isNeedTransformOldCache,
            FTMobileAgentFlutter.KEY_FILE_DATA_STORE_SHADOW to sdkConfig.isFileDataStoreShadow,
